export default function TermsOfUse() {
  return (
    <div className='text-white'>
      ...
      <p>
        By using Spotify Clone, you agree to be bound by these Terms of Use. If
        you do not agree with these terms, please do not use this application.
      </p>
      <ul className='list-decimal pl-6'>
        <li>
          <h1 className='font-bold'>Use of the Application</h1>
          <ul className='list-disc pl-12'>
            <li>
              <p>
                Spotify Clone is provided for personal, non-commercial use. You
                may not use this application for any illegal or unauthorized
                purpose. You agree to comply with all applicable laws and
                regulations while using Spotify Clone.
              </p>
            </li>
            <li>
              <p>
                You are responsible for maintaining the confidentiality of any
                login credentials and account information associated with
                Spotify Clone. You agree not to share your account information
                with third parties and take full responsibility for any
